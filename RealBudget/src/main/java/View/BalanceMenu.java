...
public class BalanceMenu extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bud.setSalary(Double.parseDouble(jTextField1.getText()));
        bud.setRent(Double.parseDouble(jTextField2.getText()));
        bud.setFood(Double.parseDouble(jTextField3.getText()));
        bud.setCreditCard(Double.parseDouble(jTextField4.getText()));
        bud.setUtilities(Double.parseDouble(jTextField5.getText()));
        App.printAvailableMoney(bud);
        bud.getAvailableMoney();
        JOptionPane.showMessageDialog(jPanel1,"This is your available balance: " + bud.getAvailableMoney());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BalanceMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
